...
export class CountriesServiceProxy {
     ...
     * @return Success
     */
    getAllUserSpecified(): Observable<void> {
    ...
    protected processGetAllUserSpecified(response: Response): Observable<void> {
        const status = response.status;
    ...
    protected processCreate(response: Response): Observable<void> {
        const status = response.status;
...
export class LanguagesServiceProxy {
     ...
     * @return Success
     */
    getByIsoCode(isoCode: string): Observable<LanguageDto> {
        let url_ = this.baseUrl + "/api/services/app/Languages/GetByIsoCode?";
        if (isoCode !== undefined)
            url_ += "isoCode=" + encodeURIComponent("" + isoCode) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
